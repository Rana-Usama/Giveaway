...
function DetailsPageScreen(props) {
  return (
    <Screen style={styles.screen}>
      ...
      {/* Images*/}
      <Image style={{ width: RFPercentage(30), height: RFPercentage(20), marginTop: RFPercentage(3) }} source={require("../../assets/Images/p1.png")} />
        ...
        <View style={{ justifyContent: "center", alignItems: "center", width: "100%" }}>
          <View style={{ width: "100%", justifyContent: "center", alignItems: "flex-start", alignSelf: "center" }}>
            <View style={{ marginTop: RFPercentage(1.7), width: "90%", justifyContent: "flex-start", alignItems: "center", flexDirection: "row", alignSelf: "center" }}>
              <Text style={{ fontSize: RFPercentage(2.1), color: Colors.black }}>Office Furniture</Text>
              <View style={{ flexDirection: "row", justifyContent: "center", alignItems: "center", position: "absolute", right: 0 }}>
                <Text style={{ fontWeight: "bold", fontSize: RFPercentage(2.2), color: Colors.primary }}>$1500</Text>
              </View>
            </View>
            <View style={{ marginTop: RFPercentage(2), width: "90%", alignSelf: "center", justifyContent: "flex-start", alignItems: "center", flexDirection: "row" }}>
              <Text style={{ fontSize: RFPercentage(1.7), color: Colors.darkGrey }}>Stockton, LA, 67352</Text>
            </View>
            <View style={{ marginTop: RFPercentage(2.5), width: "90%", alignSelf: "center", justifyContent: "flex-start", alignItems: "center", flexDirection: "row" }}>
              <Text style={{ fontSize: RFPercentage(1.7), color: Colors.darkGrey }}>2 Seater</Text>
              <Text style={{ marginLeft: RFPercentage(5), fontSize: RFPercentage(1.7), color: Colors.darkGrey }}>1500 Meter</Text>
            </View>
          </View>
          ...
          >
            <View style={{ marginLeft: RFPercentage(2), justifyContent: "center", alignItems: "center" }}>
              ...
              <Text style={{ marginTop: RFPercentage(1), color: Colors.white, fontSize: RFPercentage(1.8) }}>+55 0283582141</Text>
            </View>
